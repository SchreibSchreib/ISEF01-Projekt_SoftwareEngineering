<template>
    <div class="container m-0 p-0 min-vh-100" style="background-color: #F2F4F5;">
                ...
                <div class="col-12 col-lg-4">
                    <div class="card shadow-sm p-4 team-card">
                        ...
                        <div class="d-flex flex-column gap-3">
                            ...
                            <div
                                class="team-entry d-flex justify-content-between align-items-center p-3 shadow-sm rounded">
